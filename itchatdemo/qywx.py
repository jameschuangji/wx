...
class WeChat:
    def __init__(self):
        self.CORPID = 'wwb8ed5a7f6e7f8d71'  #企业ID，在管理后台获取
        self.CORPSECRET = 'oJkYgiD-vzFQ97c7Xyd8M00Fmc2j7teuvYWcgphyj9E'#自建应用的Secret，每个自建应用里都有单独的secret
        self.AGENTID = '1000002'  #应用ID，在后台应用中获取
        self.TOUSER = "纪闯"  # 接收者用户名,多个用户用|分割
